...
router.route('/items').get(isAuthenticatedUser, authorizeRoles('administrator','user'), getItemList);
router.route('/item/:id').get(isAuthenticatedUser, authorizeRoles('administrator','user'), getSingleItem);
router.route('/item/new').post(isAuthenticatedUser, authorizeRoles('administrator','user'),addItem);
...
router.route('/admin/item/:id').delete(isAuthenticatedUser, authorizeRoles('administrator', 'user'), deleteItem);
